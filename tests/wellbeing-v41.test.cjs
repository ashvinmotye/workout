...
assert.match(html, /styles\.css\?v=43[\s\S]*wellness\.js\?v=43[\s\S]*app\.js\?v=43/, "Current assets should be cache-busted");
assert.match(worker, /wellbeing-v43/, "The current version should use a fresh offline cache");
