...
assert.match(html, /id="appVersion"[^>]*>Version 44</, "Settings should show the cache-visible version discreetly");
...
assert.match(worker, /wellbeing-v44/);
assert.match(html, /styles\.css\?v=44[\s\S]*wellness\.js\?v=44[\s\S]*app\.js\?v=44/);
