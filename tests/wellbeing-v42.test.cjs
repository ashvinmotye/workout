...
assert.match(html, /id="appVersion"[^>]*>Version 43</, "Settings should show the cache-visible version discreetly");
...
assert.match(html, /styles\.css\?v=43[\s\S]*wellness\.js\?v=43[\s\S]*app\.js\?v=43/);
