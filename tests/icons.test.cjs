...
assert.match(html,/styles\.css\?v=40/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=40/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=40/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v40/,"Wellbeing should use the Version 40 offline cache");
