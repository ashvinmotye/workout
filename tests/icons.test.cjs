...
assert.match(html,/styles\.css\?v=37/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=37/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=37/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v37/,"Wellbeing should use the Version 37 offline cache");
