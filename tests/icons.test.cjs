...
assert.match(html,/styles\.css\?v=46/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=46/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=46/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v46/,"Wellbeing should use the Version 46 offline cache");
