...
assert.match(html,/styles\.css\?v=33/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=33/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=33/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v33/,"Wellbeing should use the Version 33 offline cache");
