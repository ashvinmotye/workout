...
assert.match(html,/styles\.css\?v=42/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=42/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=42/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v42/,"Wellbeing should use the Version 42 offline cache");
