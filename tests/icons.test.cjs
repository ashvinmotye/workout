...
assert.match(html,/styles\.css\?v=41/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=41/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=41/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v41/,"Wellbeing should use the Version 41 offline cache");
