...
assert.match(html,/styles\.css\?v=34/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=34/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=34/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v34/,"Wellbeing should use the Version 34 offline cache");
