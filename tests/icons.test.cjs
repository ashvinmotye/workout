...
assert.match(html,/styles\.css\?v=45/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=45/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=45/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v45/,"Wellbeing should use the Version 45 offline cache");
