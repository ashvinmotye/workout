...
assert.match(html,/styles\.css\?v=44/,"Wellbeing should version its stylesheet");
assert.match(html,/wellness\.js\?v=44/,"Wellbeing should version its body-data script");
assert.match(html,/app\.js\?v=44/,"Wellbeing should version its app script");
assert.match(worker,/wellbeing-v44/,"Wellbeing should use the Version 44 offline cache");
